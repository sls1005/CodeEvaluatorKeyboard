...
import test.sls1005.projects.codeevaluatorkeyboard.ui.theme.CodeEvaluatorKeyboardTheme
            ...
            CodeEvaluatorKeyboardTheme {
                Scaffold(
                    ...
                    Column(
                        ...
                        Text("Things are yet to be documented.", fontSize = 20.sp, modifier = Modifier.padding(20.dp))
                        Text("About", fontSize = 20.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(10.dp))
                        Text(
                            buildAnnotatedString {
                                val url = "https://github.com/sls1005/CodeEvaluatorKeyboard"
